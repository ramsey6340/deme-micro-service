package com.infinity.serviceauth.models;
...
public class User {
    /**
     * User réprésente les utilisateurs de l'application Deme, cela peut être les users simple et les organisations humanitaire
     */
